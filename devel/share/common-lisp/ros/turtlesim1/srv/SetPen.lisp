...
(cl:defmethod cl:initialize-instance :after ((m <SetPen-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPen-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim1-srv:<SetPen-request> is deprecated: use turtlesim1-srv:SetPen-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetPen-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPen-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim1-srv:<SetPen-response> is deprecated: use turtlesim1-srv:SetPen-response instead.")))
