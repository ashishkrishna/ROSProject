...
(cl:defmethod cl:initialize-instance :after ((m <Kill-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Kill-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim1-srv:<Kill-request> is deprecated: use turtlesim1-srv:Kill-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Kill-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Kill-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim1-srv:<Kill-response> is deprecated: use turtlesim1-srv:Kill-response instead.")))
