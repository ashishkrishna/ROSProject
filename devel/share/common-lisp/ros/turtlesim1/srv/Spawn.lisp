...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim1-srv:<Spawn-request> is deprecated: use turtlesim1-srv:Spawn-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim1-srv:<Spawn-response> is deprecated: use turtlesim1-srv:Spawn-response instead.")))
