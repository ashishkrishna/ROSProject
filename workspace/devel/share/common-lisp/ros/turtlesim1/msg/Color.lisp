...
(cl:defmethod cl:initialize-instance :after ((m <Color>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Color)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim1-msg:<Color> is deprecated: use turtlesim1-msg:Color instead.")))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <Color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim1-msg:r-val is deprecated.  Use turtlesim1-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'g-val :lambda-list '(m))
(cl:defmethod g-val ((m <Color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim1-msg:g-val is deprecated.  Use turtlesim1-msg:g instead.")
  (g m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <Color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim1-msg:b-val is deprecated.  Use turtlesim1-msg:b instead.")
  (b m))
