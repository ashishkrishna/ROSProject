...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlesim1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ashishk/workspace/install/${idir}'.  Ask the maintainer 'ashishk <ashishk@berkeley.edu>' to fix it.")
    endif()
